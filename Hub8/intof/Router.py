...
# A device is onboarded in the disable state
...
def update_relsen (jrelsen):
    ...
    if (schedule):  rs.schedule = json.dumps ({'schedule' : schedule})   # store it as a stringified json
...
from intof.Bridge import build_device_inventory
